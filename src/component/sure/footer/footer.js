        ...
        <footer className='footer'>
            <ul className='social-list'>
                <li className='social-list__item'>
                    <a className='social-list__link' href="http://t.me/Adam0saadi">
                        <i className="fab fa-telegram" aria-hidden="true"></i>
                    </a>
                </li>
                <li className='social-list__item'>
                    <a className='social-list__link' href="http://Instagram.com/a.d.a.m_s.a.a.d.i">
                ...
                <li className='social-list__item'>
                    <a className='social-list__link' href="https://www.linkedin.com/in/adam-saadi-939565202">
