      ...
      <div className="container">
        ...
        <section className="my-services" id="services">
          ...
          <div className="services">
            ...
            <div className="service">
              <h3>Design</h3>
              <p>
              I am a professional website designer, I enjoy putting all my energy, and experience into making great designs and delivering creative ideas.</p>
            </div>

            <div className="service">
              <h3>Website development</h3>
              <p>
              Full-stack development, I build high-quality websites and software utilizing different tools such as React, HTML, and CSS. I also do SEO making your web go up in search results. I customize your website to be fast, reliable, and to reflect your preferences.              </p>
            </div>

            <div className="service">
              <h3>Python development </h3>
              <p>
              This is one of the most enjoyable parts of my work. I am passionate about math and programming; I have studied advanced courses in python and used it to deliver a few projects.              </p>
            </div>
        ...
        <section className="about-me" id="about">
          ...
          <div className="about-me__body">
            <p>
              My name is Adam Saadi. I am 17 years old, I have started my learning (and working journey) at a very young age, I am motivated by creative ideas.
              ...
              I love spending time with friends and family, discussing new ideas, I respect the environment, and work for it.
